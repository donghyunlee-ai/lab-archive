...
We are pleased to welcome a new **Undergraduate Researcher** to our lab!

**Yeonhoo Park** has joined the team and will be contributing to our ongoing research projects. We are excited to have you on board and look forward to your great work!
...
<div class="row mt-3">
    <div class="col-sm text-center">
        {% include figure.liquid loading="eager" path="assets/img/pic_yhp.jpeg" title="Yeonhoo Park" class="img-fluid rounded z-depth-1" width="30%" %}
        <div class="caption">Yeonhoo Park</div>
    </div>
</div>
